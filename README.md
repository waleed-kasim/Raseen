...
```mermaid
graph TD
    A[Start Review] --> B{Spaced Repetition Algo}
    B -- Weak Page --> C[Daily Revision]
    B -- Strong Page --> D[Spaced Intervals]
    C --> E[Active Recall & Games]
    D --> E
    E --> F[Solidified Long-Term Memory]
```
